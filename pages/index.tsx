  ...
  return (
    <>
      <PageTemplate>
        <div className={styles.main}>
          <div className={styles.front}>
            ...
            <p>
              ...
              Aspernatur enim accusamus numquam, atque distinctio nihil fugiat
              facere sint mollitia omnis velit reiciendis assumenda aperiam
              molestias architecto placeat sed ducimus amet.
            </p>
            <button
        ...
        <div id="learnmore" className={styles.background}>
